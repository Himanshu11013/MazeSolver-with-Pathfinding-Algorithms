...
//     Node(int x = 0, int y = 0) : x(x), y(y), isWall(false), visited(false), distance(INT_MAX), parent(nullptr) {}
// };
...
//         if (isRunning) drawPath(window, end);
...
//                 sf::sleep(sf::milliseconds(1)); // Delay for visualization
//             }
//         }
//     }
// }
...
//     std::cout << "Choose algorithm: 1. Dijkstra 2. BFS 3. DFS\n";
//     int choice;
//     std::cin >> choice;
